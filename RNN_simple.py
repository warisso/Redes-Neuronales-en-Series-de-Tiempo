...
# Importacion de los programas usuales para graficas y calculos
import numpy as np
...
seq_size = 24  # Numero de pasos temporales para mirar atrás 
...
model = Sequential()
model.add(SimpleRNN(64, input_shape=(1, seq_size), activation='relu')) 
model.add(Dense(32))
model.add(Dense(1))
...
# Train Score: 115377.90 RMSE
# Test Score: 239890.58 RMSE
