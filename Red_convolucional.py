...
from keras.layers import Dense, LSTM, Conv1D, ConvLSTM2D, Flatten
...
# Train Score: 126589.61 RMSE
# Test Score: 230629.25 RMSE
...
#predicción con una red Convolucional
prediction = [] #Empty list to populate later with predictions
current_batch = test[-seq_size:] #Final data points in train 
...
for i in range(len(test),len(test) + future):
    ...
    current_batch=np.reshape(current_batch, (1, 1, 1, 1, current_batch.shape[0]))
